...
switch ($route) {
	case 'agree': 	include './flarum/route/agree.php'; 	break;
	case 'browser': include './flarum/route/browser.php'; 	break;
	case 'forum': 	include './flarum/route/forum.php'; 	break;
	case 'index': 	include './flarum/route/index.php'; 	break;
	case 'mod': 	include './flarum/route/mod.php'; 		break;
	case 'my': 	include './flarum/route/my.php'; 		break;
	case 'post': 	include './flarum/route/post.php'; 		break;
	case 'search': 	include './flarum/route/search.php'; 	break;
	case 'test': 	include './flarum/route/test.php'; 		break;
	case 'thread':	include './flarum/route/thread.php'; 	break;
	case 'user': 	include './flarum/route/user.php'; 		break;
	default: message(-1, '该功能未实现。');
	/*
	default:
		$route = preg_match("/^\w+$/", $route) ? $route : 'index';
		$filename = "./flarum/route/$route.php";
...
function message($code, $message) {
	...
	if($ajax) {
		...
		$header['title'] = '提示信息';
		include "./flarum/view/message.htm";
	}
	exit;
}
