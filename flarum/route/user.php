...
// 注册第1步：校验 Email/code
	...
	if($method == 'GET') {
		...
		include './flarum/view/user_create.htm';
...
// 注册第3步：设置密码，创建用户
	...
	if($method == 'GET') {
		...
		include './flarum/view/user_setpw.htm';
...
// 用户发表的喜欢
	...
	include './flarum/view/user_agree.htm';
...
// 用户发表的主题
	...
	include './flarum/view/user_thread.htm';
...
// 找回密码第1步
	...
	if($method == 'GET') {
		...
		include './flarum/view/user_findpw.htm';
